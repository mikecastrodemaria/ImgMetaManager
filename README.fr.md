...
release GitHub dont les notes viennent du changelog. Il est idempotent : une
version déjà publiée est laissée telle quelle. L'onglet Actions permet aussi de
le lancer à la main.
